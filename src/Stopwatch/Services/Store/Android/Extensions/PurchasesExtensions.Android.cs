...
using Uno.RevenueCat.InAppBilling.Platforms.Android.Delegates;
...
internal static class PurchasesExtensions
{
    ...
    internal static Task<PurchaseSuccessInfo> PurchaseAsync(this Purchases purchases, Activity activity,
        Com.Revenuecat.Purchases.Package packageToPurchase, CancellationToken cancellationToken = default)
    {
